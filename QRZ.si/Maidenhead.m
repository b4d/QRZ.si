...
+ (Coordinates) fromMaidenhead: (NSString *) maidenhead {
    ...
    if ([maidenhead length] >= 5) {
        coordinates.lon += ((int)[[maidenhead lowercaseString] characterAtIndex:4] - (int)'a') * 0.0833333333;
        coordinates.lat += ((int)[[maidenhead lowercaseString] characterAtIndex:5] - (int)'a') * 0.0416666667;
